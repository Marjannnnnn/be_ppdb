...
<body style="font-family: sans-serif">
    ...
    <table width="50%" border="0" style="margin-left:3%;margin-right:2%;float:left">
        ...
        <tr>
            ...
            <td width="3%">:</td>
            <td>{{ $pendaftaran->nomor_handphone }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3">Akses<a style="font: blue; text-decoration: none;" href="http://localhost:3000/login">
                    http://localhost:3000/login</a>, login gunakan
            </td>
        </tr>
        <tr>
            <td colspan="3">Email : {{ $user->email }}</td>
        </tr>
        <tr>

            <td colspan="3">Password : {{ $pendaftaran->NISN }}</td>
        </tr>
        <tr>
    ...
    <table width="37%" border="0">
        ...
        <tr>
            <td>
                1. Formulir A1 - Daftar Nilai dan Kehadiran ditandatangani Kepala {{ $pendaftaran->asal_sekolah }}br>
